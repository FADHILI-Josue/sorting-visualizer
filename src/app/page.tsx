...
export default function Home() {
  ...
  return (
    <main className="absolute top-0 h-screen w-screen z-[-2] bg-[#081c15] bg-[radial-gradient(#ffffff33_1px,#081c15_1px)] bg-[size:40px_40px]">
        ...
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            ...
            <div className="hidden sm:flex absolute top-[120%] left-0 w-full">
              <div className="flex w-full text-gray-400 p-4 rounded border border-system-green80 bg-system-green80 bg-opacity-10 gap-6">
